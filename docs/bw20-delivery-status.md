...
> 2026-09-22：当前交付入口已更新为 [单候选真实 Agent MVP](mvp-single-candidate-delivery.md)。
> BW20 Agent 微基准已有真实验收与签署；服务级 Campaign 也已完成正式 D 裁决与签署，结论为 inconclusive。
> 以下内容为 9 月 10 日 Framework Smoke 阶段历史，不再作为当前待办清单。

本页保留 Framework Smoke 阶段历史索引；当前状态以上方交付入口为准。
本交付是范围受限的 Framework Smoke，不是完整自动优化系统验收。

2026-09-10 更新：可选单任务签核已部署，用户已完成当前功能任务签核，数据库回查为
`completed`。下表保留 PR149 原交付边界；最新第三步接入差异与待授权范围见
[BW20 Stage 0 接入切片](bw20-stage0-integration.md)。不改变原目标 blocker 或性能状态。
