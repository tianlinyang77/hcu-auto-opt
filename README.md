...
**最新执行目标：[本周完整多候选 MVP](docs/plans/mvp-multicandidate-week.md)。**
下述单候选交付继续保留，但“多候选后续增强、不阻塞交付”的临时安排已经撤回。
...
- [ADR-0010：M2 操作面是可信控制面的版本化外观](docs/adr/0010-m2-operator-facade.md)
